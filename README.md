# kafka [![Build Status](https://travis-ci.org/daggerok/kafka.svg?branch=v22)](https://travis-ci.org/daggerok/kafka)
...
- based on `openjdk:11-jdk-sid` image
...
docker run -it --rm --name run-my-kafka -p 2181:2181 -p 9092:9092 daggerok/kafka:v22
#docker run --rm --name run-my-kafka -p 2181:2181 -p 9092:9092 daggerok/kafka:v22
